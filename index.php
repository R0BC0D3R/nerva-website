                ...
                <div class="col-12 col-lg-4">
                    <div class="card exchanges">
                        <div class="card-body">
                            <div class="media">
                                <div class="media-body">
                                    <p><img src="images/qbtc-logo.png" height="64"></p>
                                    <h4 class="card-title">QBTC</h4>
                                    <p class="card-text">CNYT pair for the chinese market.</p>
                                    <a class="btn btn-primary" href="https://www.qbtc.com/trade?symbol=XNV_CNYT"
                                        target="_blank" rel="nofollow"><span class="fa fa-exchange-alt"></span> &nbsp;
                                        Buy Nerva</a>
                                </div>
                            </div>
